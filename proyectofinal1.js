var productos = ["Antivirus", "Grafica", "Disco duro", "Gabinete", "Bolso portatil", "Portatil", "Memoria RAM", "Router", "Chromecast TV"];
...
var precios = [1200, 170000, 5400, 7000, 2500, 130000, 9000, 3000, 12000];
...
var ex_regular_dni; 
    ...
    var vNombreCalle = document.getElementById("NombreCalle").value;
        if( vNombreCalle == null || vViaNombre.length == 0 || /^\s+$/.test(vViaNombre) || !isNaN(vViaNombre)) {
            todoBien=false;
            document.getElementById("NombreCalle").className = "textMal";
}
        else{
            document.getElementById("NombreCalle").className = "textBien";
} 
 
 
    var vNumero = document.getElementById("vNumero").value;
        if( vNumero=="" || isNaN(vNumero) ) {
            todoBien=false;
            document.getElementById("vNumero").className = "textMal";
} 
        else{
            document.getElementById("vNumero").className = "textBien";
} 
